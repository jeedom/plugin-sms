...
class GsmModem(SerialComms):
    ...
    def sendSms(self, destination, text, waitForDeliveryReport=False, deliveryTimeout=120, sendFlash=False):
        ...
        if self._smsTextMode:
            ...
            result = lineStartingWith('+CMGS:', self.write(text, timeout=60, writeTerm=chr(26)))
        else:
