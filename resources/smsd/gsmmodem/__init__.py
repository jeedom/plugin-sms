...
gsmmodem.modem.IncomingCall: wraps an incoming call and passed to the incoming call handler callback function
gsmmodem.modem.ReceivedSms: wraps a received SMS message and passed to the sms received handler callback function
