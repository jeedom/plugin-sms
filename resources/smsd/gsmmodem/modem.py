...
class GsmModem(SerialComms):
    ...
    def __init__(self, port, baudrate=115200, incomingCallCallbackFunc=None, smsReceivedCallbackFunc=None, smsStatusReportCallback=None, requestDelivery=True, AT_CNMI="", dsrdtr=True, rtscts=True, *a, **kw):
        super(GsmModem, self).__init__(port, baudrate, notifyCallbackFunc=self._handleModemNotification, dsrdtr=dsrdtr, rtscts=rtscts, *a, **kw)
