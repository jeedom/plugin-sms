...
-   **Usuario** : usuario correspondiente en Jeedom (permite
...
-   **Configuración avancée** (ruedas con muescas pequeñas) : permet
...
> **Configuración de la clef Alcatel one touch X220L**
>
